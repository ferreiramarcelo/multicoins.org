...
{
    if (!exports.coinsInfo[networkID] || !exports.coinsInfo[networkID].name || !bitcoin.networks[exports.coinsInfo[networkID].name])
        return 0;
...
exports.updateTransactions = function(callback)
{
    ...
    for (var key in jsonSavedKeyPairs)
    {
        if (!coins[jsonSavedKeyPairs[key].network]) 
            continue;
